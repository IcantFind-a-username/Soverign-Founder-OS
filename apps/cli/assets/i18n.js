...
const STRINGS = {
  en: {
    ...
    gauntlet_intro: "Eight attacks against the running kernel: token replay, input substitution, executing without the owner's admission, a manifest demanding host capabilities, an infinite-loop plugin, red-zone data exfiltration, approval bypass, and audit tampering. Nothing is mocked.",
    loading: "loading…",
  ...
  zh: {
    ...
    gauntlet_intro: "对运行中的内核发起八项攻击:令牌重放、输入替换、未经所有者准入的执行、清单越权申请、死循环插件、红区数据外泄、绕过审批、篡改审计。全部真实执行,绝无模拟。",
    loading: "加载中…",
